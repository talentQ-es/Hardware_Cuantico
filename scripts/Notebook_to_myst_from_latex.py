...
from build_functions import build_card_box, build_prf_box
...
for i in reversed(range(len(index_list_list[0]))):
    ...
    if 'definicion' in title_lowercase or title_lowercase == '':
        ...
        #build_card_box(i, f_data, index_list_list, titles_list_list)
        build_prf_box(i, f_data, index_list_list, titles_list_list, "theorem")

    elif 'lema' in title_lowercase or 'lemma' in title_lowercase :
        #build_card_box(i, f_data, index_list_list, titles_list_list)
        build_prf_box(i, f_data, index_list_list, titles_list_list, "lemma")
    
    elif 'corolario' in title_lowercase:
        #build_card_box(i, f_data, index_list_list, titles_list_list)
        build_prf_box(i, f_data, index_list_list, titles_list_list, "corollary")

    #elif 'postulado' in title_lowercase:
    #    build_card_box(i, f_data, index_list_list, titles_list_list)
    #    build_prf_box(i, f_data, index_list_list, titles_list_list, "")

    elif 'proposicion' in title_lowercase:
        #build_card_box(i, f_data, index_list_list, titles_list_list)
        build_prf_box(i, f_data, index_list_list, titles_list_list, "proposition")

    elif 'axioma' in title_lowercase:
        #build_card_box(i, f_data, index_list_list, titles_list_list)
        build_prf_box(i, f_data, index_list_list, titles_list_list, "axiom")
    ...
    elif 'resumen' in title_lowercase or "jupyter notebook" in title_lowercase:
